...
:root {
  ...
  --green-100:  oklch(0.93 0.065 145);
  --green-200:  oklch(0.86 0.130 145);
  --green-300:  oklch(0.77 0.185 145);
  --green-400:  oklch(0.68 0.235 145);
  --green-500:  oklch(0.59 0.260 145);  /* ← primary */
  --green-600:  oklch(0.49 0.230 145);
  --green-700:  oklch(0.39 0.190 145);
  --green-800:  oklch(0.27 0.130 145);
  --green-900:  oklch(0.16 0.075 145);
  ...
  /* ── Vivid Coral ─────────────────── */
  --coral-200:  oklch(0.88 0.120 28);
  --coral-300:  oklch(0.78 0.185 28);
  --coral-500:  oklch(0.63 0.240 28);   /* ← danger */
  --coral-700:  oklch(0.46 0.200 28);
  --coral-900:  oklch(0.27 0.120 28);

  /* ── Light Surfaces ──────────────── */
  --surface-base:     oklch(0.985 0.006 145);
  ...
  --dark-surface-raised:   oklch(0.155 0.030 145);
  --dark-surface-overlay:  oklch(0.205 0.035 145);
